<?php  //[STAMP] 827555ec52e9dba0edea7b2cd17ef945
// phpcs:ignoreFile
namespace SprykerFeatureTest\Zed\ProductExperienceManagement\_generated;

// This class was automatically generated by build task
// You should not change it manually as it will be overwritten on next build

trait ProductExperienceManagementBusinessTesterActions
{
    /**
     ...
     * @see \SprykerFeatureTest\Shared\ProductExperienceManagement\Helper\ImportJobHelper::haveImportJob()
     */
    public function haveImportJob(array $seedData = []): \Generated\Shared\Transfer\ImportJobTransfer {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('haveImportJob', func_get_args()));
    }
     ...
     *
     * @param array<string, mixed> $seedData
     * @see \SprykerFeatureTest\Shared\ProductExperienceManagement\Helper\ImportJobHelper::haveImportJobRun()
     */
    public function haveImportJobRun(array $seedData = []): \Generated\Shared\Transfer\ImportJobRunTransfer {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('haveImportJobRun', func_get_args()));
    }
     ...
     *
     * @param array<string, mixed> $seedData
     * @see \SprykerFeatureTest\Shared\ProductExperienceManagement\Helper\ImportJobHelper::haveImportJobRunError()
     */
    public function haveImportJobRunError(int $idImportJobRun, array $seedData = []): void {
        $this->getScenario()->runStep(new \Codeception\Step\Action('haveImportJobRunError', func_get_args()));
    }
}
